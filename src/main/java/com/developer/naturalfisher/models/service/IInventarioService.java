...
public interface IInventarioService {
	...
	boolean inventariar(Producto producto, ItemVenta itemVenta, ItemPromocionVenta itemPromocionVenta);
	boolean inventariarPromocion(ItemPromocionVenta itemVenta);
